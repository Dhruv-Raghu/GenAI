...
# Classes for Amazon Bedrock Foundation Models
# Follows the Bedrock documentation. Amazon models work differently compared to Anthropic models hence the different classes
